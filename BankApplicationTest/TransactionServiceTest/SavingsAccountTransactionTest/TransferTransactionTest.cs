...
namespace BankApplicationTest.TransactionServiceTest.SavingsAccountTransactionTest
{
    public class TransferTransactionTest
    {
        ...
        public void TransferFunds_ValidTransfer_ShouldDecreaseSourceBalanceAndIncreaseDestinationBalance()
        {
            ...
            var sourceAccount = new SavingsAccount("2344456", sourceCustomer, 10000.0);
            var destinationAccount = new SavingsAccount("7878778", destinationCustomer, 1000.0);
        ...
        {
            var destinationCustomer = new Customer();
            var destinationAccount = new SavingsAccount("789012", destinationCustomer, 2000.0);
            double destinationInitialBalance = destinationAccount.Balance;
